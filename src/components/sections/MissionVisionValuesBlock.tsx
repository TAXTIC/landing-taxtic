  ...
  return (
    <div className="mt-12">
      <div className="grid gap-6 md:grid-cols-2 mb-12">
        <article className="bg-(--background) border-l-[3px] border-(--brand-orange) p-8">
          <Target
            size={32}
            strokeWidth={1.75}
            ...
            aria-hidden="true"
          />
          <h3 className="label-upper text-(--gray-700) mb-3">
      ...
      <div>
        <p className="label-upper text-(--gray-700) mb-6 text-center">
          {content.valuesLabel}
        </p>
